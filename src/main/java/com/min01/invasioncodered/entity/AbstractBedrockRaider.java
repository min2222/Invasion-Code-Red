...
{
	private static final EntityDataAccessor<Integer> SKIN_ID = SynchedEntityData.defineId(AbstractBedrockRaider.class, EntityDataSerializers.INT);
	private static final EntityDataAccessor<String> STATE = SynchedEntityData.defineId(AbstractBedrockRaider.class, EntityDataSerializers.STRING);
	private static final EntityDataAccessor<Boolean> IS_DELAYED_ATTACKING = SynchedEntityData.defineId(AbstractBedrockRaider.class, EntityDataSerializers.BOOLEAN);
	private static final EntityDataAccessor<Boolean> IS_EVENT_FIRED = SynchedEntityData.defineId(AbstractBedrockRaider.class, EntityDataSerializers.BOOLEAN);
